...
function BCIdentity () {
  ...
  bc.identity.OPERATION_ATTACH_BLOCKCHAIN_IDENTITY =
    'ATTACH_BLOCKCHAIN_IDENTITY'
  bc.identity.OPERATION_DETACH_BLOCKCHAIN_IDENTITY =
  ...
  bc.identity.OPERATION_ATTACH_PARENT_WITH_IDENTITY =
   ...
   */
  bc.identity.attachFacebookIdentity = function (
    facebookId,
    authenticationToken,
    callback
  ) {
   ...
   *
   */
  bc.identity.mergeFacebookIdentity = function (
    facebookId,
    authenticationToken,
    callback
  ) {
   ...
   */
  bc.identity.detachFacebookIdentity = function (
    facebookId,
    continueAnon,
    callback
  ) {
   ...
   */
  bc.identity.attachUltraIdentity = function (
    ultraUsername,
    ultraIdToken,
    callback
  ) {
   ...
   *
   */
  bc.identity.mergeUltraIdentity = function (
    ultraUsername,
    ultraIdToken,
    callback
  ) {
   ...
   * the profile wouldn't be retrievable if the user loses their device)
   */
  bc.identity.detachUltraIdentity = function (
    ultraUsername,
    continueAnon,
    callback
  ) {
   ...
   */
  bc.identity.attachAdvancedIdentity = function (
    authenticationType,
    ids,
    extraJson,
    callback
    ...
    if (
      ids.authenticationSubType !== null ||
   ...
   *
   */
  bc.identity.mergeAdvancedIdentity = function (
    authenticationType,
    ids,
    extraJson,
    callback
   ...
   * the profile wouldn't be retrievable if the user loses their device)
   */
  bc.identity.detachAdvancedIdentity = function (
    authenticationType,
    externalId,
    continueAnon,
    extraJson,
   ...
   * To switch profiles, call ClearSavedProfileID() and call AuthenticateFacebook().
   */
  bc.identity.attachFacebookLimitedIdentity = function (
    facebookLimitedId,
    authenticationToken,
    callback
  ) {
   ...
   *
   */
  bc.identity.mergeFacebookLimitedIdentity = function (
    facebookLimitedId,
    authenticationToken,
    callback
  ) {
   ...
   * the profile wouldn't be retrievable if the user loses their device)
   */
  bc.identity.detachFacebookLimitedIdentity = function (
    facebookId,
    continueAnon,
    callback
  ) {
   ...
   * the profile wouldn't be retrievable if the user loses their device)
   */
  bc.identity.detachGameCenterIdentity = function (
    gameCenterId,
    continueAnon,
    callback
  ) {
   ...
   * the profile wouldn't be retrievable if the user loses their device)
   */
  bc.identity.detachUniversalIdentity = function (
    userId,
    continueAnon,
    callback
  ) {
   ...
   */
  bc.identity.attachSteamIdentity = function (
    steamId,
    sessionTicket,
    callback
  ) {
   ...
   */
  bc.identity.attachGoogleIdentity = function (
    googleId,
    authenticationToken,
    callback
  ) {
   ...
   *
   */
  bc.identity.mergeGoogleIdentity = function (
    googleId,
    authenticationToken,
    callback
  ) {
   ...
   * the profile wouldn't be retrievable if the user loses their device)
   */
  bc.identity.detachGoogleIdentity = function (
    googleId,
    continueAnon,
    callback
  ) {
   ...
   * To switch profiles, call ClearSavedProfileID() and call AuthenticateGoogle().
   */
  bc.identity.attachGoogleOpenIdIdentity = function (
    googleOpenId,
    authenticationToken,
    callback
  ) {
   ...
   *
   */
  bc.identity.mergeGoogleOpenIdIdentity = function (
    googleOpenId,
    authenticationToken,
    callback
  ) {
   ...
   * the profile wouldn't be retrievable if the user loses their device)
   */
  bc.identity.detachGoogleOpenIdIdentity = function (
    googleOpenId,
    continueAnon,
    callback
  ) {
   ...
   * To switch profiles, call ClearSavedProfileID() and call AuthenticateApple().
   */
  bc.identity.attachAppleIdentity = function (
    appleId,
    authenticationToken,
    callback
  ) {
   ...
   *
   */
  bc.identity.mergeAppleIdentity = function (
    appleId,
    authenticationToken,
    callback
  ) {
   ...
   */
  bc.identity.attachTwitterIdentity = function (
    twitterId,
    authenticationToken,
    secret,
    callback
   ...
   *
   */
  bc.identity.mergeTwitterIdentity = function (
    twitterId,
    authenticationToken,
    secret,
    callback
   ...
   * the profile wouldn't be retrievable if the user loses their device)
   */
  bc.identity.detachTwitterIdentity = function (
    twitterId,
    continueAnon,
    callback
  ) {
   ...
   */
  bc.identity.attachParseIdentity = function (
    parseId,
    authenticationToken,
    callback
  ) {
   ...
   *
   */
  bc.identity.mergeParseIdentity = function (
    parseId,
    authenticationToken,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.identity.switchToChildProfile = function (
    childProfileId,
    childAppId,
    forceCreate,
    callback
  ) {
    bc.identity.switchToChildProfileInternal(
      childProfileId,
      childAppId,
      forceCreate,
      false,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.identity.switchToSingletonChildProfile = function (
    childAppId,
    forceCreate,
    callback
  ) {
   ...
   */
  bc.identity.attachBlockchainIdentity = function (
    blockchainConfig,
    publicKey,
    callback
  ) {
   ...
   */
  bc.identity.getIdentityStatus = function (
    authenticationType,
    externalAuthName,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.identity.refreshIdentity = function (
    externalId,
    authenticationToken,
    authenticationType,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.identity.changeEmailIdentity = function (
    oldEmailAddress,
    password,
    newEmailAddress,
    updateContactEmail,
   ...
   * @param cbObject The user object sent to the callback
   */
  bc.identity.attachParentWithIdentity = function (
    externalId,
    authenticationToken,
    authenticationType,
    externalAuthName,
   ...
   * @param cbObject The user object sent to the callback
   */
  bc.identity.attachPeerProfile = function (
    peer,
    externalId,
    authenticationToken,
    authenticationType,
  ...
  bc.identity.attachIdentity = function (
    externalId,
    authenticationToken,
    authenticationType,
    callback
  ...
  bc.identity.mergeIdentity = function (
    externalId,
    authenticationToken,
    authenticationType,
    callback
  ...
  bc.identity.detachIdentity = function (
    externalId,
    authenticationType,
    continueAnon,
    callback
  ...
  bc.identity.switchToChildProfileInternal = function (
    childProfileId,
    childAppId,
    forceCreate,
    forceSingleton,
