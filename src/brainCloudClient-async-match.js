...
function BCAsyncMatch () {
  ...
  bc.asyncMatch.OPERATION_ABANDON_MATCH_WITH_SUMMARY_DATA =
    'ABANDON_MATCH_WITH_SUMMARY_DATA'
  bc.asyncMatch.OPERATION_COMPLETE_MATCH_WITH_SUMMARY_DATA =
    'COMPLETE_MATCH_WITH_SUMMARY_DATA'
  bc.asyncMatch.OPERATION_UPDATE_MATCH_STATE_CURRENT_TURN =
   ...
   */
  bc.asyncMatch.createMatch = function (
    opponentIds,
   ...
   * @param callback Optional instance of IServerCallback to call when the server response is received.
   */
  bc.asyncMatch.createMatchWithInitialTurn = function (
    opponentIds,
    matchState,
    pushNotificationMessage,
    nextPlayer,
   ...
   * @param callback Optional instance of IServerCallback to call when the server response is received.
   */
  bc.asyncMatch.submitTurn = function (
    ownerId,
    matchId,
    version,
    matchState,
   ...
   * @param callback Optional instance of IServerCallback to call when the server response is received.
   */
  bc.asyncMatch.updateMatchSummaryData = function (
    ownerId,
    matchId,
    version,
    summary,
   ...
   * @param callback  Optional instance of IServerCallback to call when the server response is received.
   */
  bc.asyncMatch.completeMatchWithSummaryData = function (
    ownerId,
    matchId,
    pushContent,
    summary,
   ...
   * @param callback  Optional instance of IServerCallback to call when the server response is received.
   */
  bc.asyncMatch.abandonMatchWithSummaryData = function (
    ownerId,
    matchId,
    pushContent,
    summary,
   ...
   * @param callback Optional instance of IServerCallback to call when the server response is received.
   */
  bc.asyncMatch.updateMatchStateCurrentTurn = function (
    ownerId,
    matchId,
    version,
    matchState,
