...
function BCScript () {
  ...
  bc.script.OPERATION_GET_SCHEDULED_CLOUD_SCRIPTS =
    'GET_SCHEDULED_CLOUD_SCRIPTS'
  bc.script.OPERATION_GET_RUNNING_OR_QUEUED_CLOUD_SCRIPTS =
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.script.scheduleRunScriptMillisUTC = function (
    scriptName,
    scriptData,
    startDateInUTC,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.script.scheduleRunScriptMinutes = function (
    scriptName,
    scriptData,
    minutesFromNow,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.script.runParentScript = function (
    scriptName,
    scriptData,
    parentLevel,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.script.runPeerScriptAsync = function (
    scriptName,
    scriptData,
    peer,
    callback
