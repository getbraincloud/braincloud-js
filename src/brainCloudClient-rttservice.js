...
function BCRTT () {
  ...
  bc.rttService.OPERATION_REQUEST_CLIENT_CONNECTION =
  ...
  bc.rttService.registerRTTEventCallback = function (callback) {
    bc.brainCloudRttComms.registerRTTCallback(
      bc.rttService.SERVICE_EVENT,
      callback
    )
  }
  ...
  bc.rttService.registerRTTMessagingCallback = function (callback) {
    bc.brainCloudRttComms.registerRTTCallback(
      bc.rttService.SERVICE_MESSAGING,
      callback
    )
  }
  ...
  bc.rttService.registerRTTPresenceCallback = function (callback) {
    bc.brainCloudRttComms.registerRTTCallback(
      bc.rttService.SERVICE_PRESENCE,
      callback
    )
  }
  ...
  bc.rttService.registerRTTBlockchainRefresh = function (callback) {
    bc.brainCloudRttComms.registerRTTCallback(
      bc.rttService.SERVICE_USER_INVENTORY_MANAGEMENT,
      callback
    )
  }
  bc.rttService.deregisterRTTBlockchainCallback = function () {
    bc.brainCloudRttComms.deregisterRTTCallback(
      bc.rttService.SERVICE_USER_INVENTORY_MANAGEMENT
    )
  }
