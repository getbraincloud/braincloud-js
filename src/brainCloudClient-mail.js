...
function BCMail () {
  ...
  bc.mail.OPERATION_SEND_ADVANCED_EMAIL_BY_ADDRESS =
    'SEND_ADVANCED_EMAIL_BY_ADDRESS'
  bc.mail.OPERATION_SEND_ADVANCED_EMAIL_BY_ADDRESSES =
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.mail.sendAdvancedEmailByAddress = function (
    emailAddress,
    serviceParams,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.mail.sendAdvancedEmailByAddresses = function (
    emailAddresses,
    serviceParams,
    callback
  ) {
