...
function BCMatchMaking () {
  ...
  bc.matchMaking.OPERATION_FIND_PLAYERS_USING_FILTER =
  ...
  bc.matchMaking.findPlayers = function (rangeDelta, numMatches, callback) {
    bc.matchMaking.findPlayersWithAttributes(
      rangeDelta,
      numMatches,
      null,
      callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.matchMaking.findPlayersWithAttributes = function (
    rangeDelta,
    numMatches,
    jsonAttributes,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.matchMaking.findPlayersUsingFilter = function (
    rangeDelta,
    numMatches,
    extraParms,
    callback
  ) {
    bc.matchMaking.findPlayersWithAttributesUsingFilter(
      rangeDelta,
      numMatches,
      null,
      extraParms,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.matchMaking.findPlayersWithAttributesUsingFilter = function (
    rangeDelta,
    numMatches,
    jsonAttributes,
    extraParms,
