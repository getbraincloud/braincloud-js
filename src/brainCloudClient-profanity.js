...
function BCProfanity () {
  ...
  bc.profanity.OPERATION_PROFANITY_IDENTIFY_BAD_WORDS =
   ...
   */
  bc.profanity.profanityCheck = function (
    text,
    languages,
    flagEmail,
    flagPhone,
   ...
   * 40424 - WebPurify not enabled
   */
  bc.profanity.profanityReplaceText = function (
    text,
    replaceSymbol,
    languages,
    flagEmail,
   ...
   * 40424 - WebPurify not enabled
   */
  bc.profanity.profanityIdentifyBadWords = function (
    text,
    languages,
    flagEmail,
    flagPhone,
