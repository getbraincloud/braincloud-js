...
function BrainCloudRttComms (m_client) {
  ...
  bcrtt.onSocketError = function (e) {
    if (bcrtt.isRTTEnabled()) {
      // Don't spam errors if we get multiple ones
  ...
  bcrtt.onSocketOpen = function (e) {
    if (bcrtt.isRTTEnabled()) {
      // This should always be true, but just in case user called disabled and we end up receiving the event anyway
      // Yay!
  ...
  bcrtt.onSocketMessage = function (e) {
    if (bcrtt.isRTTEnabled()) {
      // This should always be true, but just in case user called disabled and we end up receiving the even anyway
