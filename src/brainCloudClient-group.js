...
function BCGroup () {
  ...
  bc.group.OPERATION_READ_GROUP_ENTITIES_PAGE_BY_OFFSET =
  ...
  bc.group.role = Object.freeze({
    owner: 'OWNER',
    admin: 'ADMIN',
    member: 'MEMBER',
    other: 'OTHER'
  })
  bc.group.autoJoinStrategy = Object.freeze({
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.addGroupMember = function (
    groupId,
    profileId,
    role,
    attributes,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.approveGroupJoinRequest = function (
    groupId,
    profileId,
    role,
    attributes,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.autoJoinGroup = function (
    groupType,
    autoJoinStrategy,
    dataQueryJson,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.autoJoinGroupMulti = function (
    groupTypes,
    autoJoinStrategy,
    where,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.incrementGroupEntityData = function (
    groupId,
    entityId,
    data,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.inviteGroupMember = function (
    groupId,
    profileId,
    role,
    attributes,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.listGroupsPageByOffset = function (
    encodedContext,
    pageOffset,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.readGroupEntitiesPageByOffset = function (
    encodedContext,
    pageOffset,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.updateGroupEntityData = function (
    groupId,
    entityId,
    version,
    data,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.updateGroupMember = function (
    groupId,
    profileId,
    role,
    attributes,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.group.updateGroupSummaryData = function (
    groupId,
    version,
    summaryData,
    callback
