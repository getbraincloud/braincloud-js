...
function BCGamification () {
  ...
  bc.gamification.OPERATION_READ_ACHIEVED_ACHIEVEMENTS =
  ...
  bc.gamification.OPERATION_READ_MILESTONES_BY_CATEGORY =
    'READ_MILESTONES_BY_CATEGORY'
  bc.gamification.OPERATION_READ_COMPLETED_MILESTONES =
    'READ_COMPLETED_MILESTONES'
  bc.gamification.OPERATION_READ_IN_PROGRESS_MILESTONES =
  ...
  bc.gamification.OPERATION_READ_QUESTS_WITH_BASIC_PERCENTAGE =
    'READ_QUESTS_WITH_BASIC_PERCENTAGE'
  bc.gamification.OPERATION_READ_QUESTS_WITH_COMPLEX_PERCENTAGE =
   ...
   * @param callback Method to be invoked when the server response is received.
   */
  bc.gamification.awardAchievements = function (
    achievements,
    callback,
    includeMetaData
  ) {
   ...
   * @param callback Method to be invoked when the server response is received.
   */
  bc.gamification.readAchievedAchievements = function (
    callback,
    includeMetaData
  ) {
    var message = {}
   ...
   * @param callback Method to be invoked when the server response is received.
   */
  bc.gamification.readMilestonesByCategory = function (
    category,
    callback,
    includeMetaData
  ) {
   ...
   * @param callback Method to be invoked when the server response is received.
   */
  bc.gamification.readCompletedMilestones = function (
    callback,
    includeMetaData
  ) {
    var message = {}
   ...
   * @param callback Method to be invoked when the server response is received.
   */
  bc.gamification.readInProgressMilestones = function (
    callback,
    includeMetaData
  ) {
    var message = {}
   ...
   * @param callback Method to be invoked when the server response is received.
   */
  bc.gamification.readQuestsByCategory = function (
    category,
    callback,
    includeMetaData
  ) {
   ...
   * @param callback Method to be invoked when the server response is received.
   */
  bc.gamification.readQuestsWithBasicPercentage = function (
    callback,
    includeMetaData
  ) {
    var message = {}
   ...
   * @param callback Method to be invoked when the server response is received.
   */
  bc.gamification.readQuestsWithComplexPercentage = function (
    callback,
    includeMetaData
  ) {
    var message = {}
