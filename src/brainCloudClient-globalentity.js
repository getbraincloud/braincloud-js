...
function BCGlobalEntity () {
  ...
  bc.globalEntity.OPERATION_INCREMENT_GLOBAL_ENTITY_DATA =
    'INCREMENT_GLOBAL_ENTITY_DATA'
  bc.globalEntity.OPERATION_GET_RANDOM_ENTITIES_MATCHING =
    'GET_RANDOM_ENTITIES_MATCHING'
  bc.globalEntity.OPERATION_UPDATE_ENTITY_INDEXED_ID = 'UPDATE_INDEXED_ID'
  bc.globalEntity.OPERATION_UPDATE_ENTITY_OWNER_AND_ACL =
   ...
   */
  bc.globalEntity.createEntity = function (
    entityType,
    timeToLive,
    acl,
    data,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.createEntityWithIndexedId = function (
    entityType,
    indexedId,
    timeToLive,
    acl,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.deleteEntity = function (entityId, version, callback) {
    var message = {
      entityId: entityId,
      version: version
    }
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.getList = function (where, orderBy, maxReturn, callback) {
    var message = {
      where: where,
      maxReturn: maxReturn
    }
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.getListByIndexedId = function (
    entityIndexedId,
    maxReturn,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.updateEntityAcl = function (
    entityId,
    acl,
    version,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.updateEntityTimeToLive = function (
    entityId,
    timeToLive,
    version,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.getPageOffset = function (context, pageOffset, callback) {
    var message = {
      context: context,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.incrementGlobalEntityData = function (
    entityId,
    data,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.getRandomEntitiesMatching = function (
    where,
    maxReturn,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.updateEntityIndexedId = function (
    entityId,
    version,
    entityIndexedId,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.updateEntityOwnerAndAcl = function (
    entityId,
    version,
    ownerId,
    acl,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.globalEntity.makeSystemEntity = function (
    entityId,
    version,
    acl,
    callback
