...
function BCPlayerState () {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.playerState.updateAttributes = function (
    attributes,
    wipeExisting,
    callback
  ) {
   ...
   */
  bc.playerState.updateSummaryFriendData = function (
    summaryFriendData,
    callback
  ) {
    bc.brainCloudManager.sendRequest({
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.playerState.extendUserStatus = function (
    statusName,
    additionalSecs,
    details,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.playerState.setUserStatus = function (
    statusName,
    durationSecs,
    details,
    callback
