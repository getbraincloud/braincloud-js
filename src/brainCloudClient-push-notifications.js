...
function BCPushNotifications () {
  ...
  bc.pushNotification.OPERATION_SEND_NORMALIZED_TO_GROUP =
    'SEND_NORMALIZED_TO_GROUP'
  bc.pushNotification.OPERATION_SEND_TEMPLATED_TO_GROUP =
  ...
  bc.pushNotification.OPERATION_SCHEDULED_NORMALIZED =
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.deregisterPushNotificationDeviceToken = function (
    deviceType,
    deviceToken,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.registerPushNotificationDeviceToken = function (
    deviceType,
    deviceToken,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendSimplePushNotification = function (
    toProfileId,
    message,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendRichPushNotification = function (
    toProfileId,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendRichPushNotificationWithParams = function (
    toProfileId,
    notificationTemplateId,
    substitutionJson,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendTemplatedPushNotificationToGroup = function (
    groupId,
    notificationTemplateId,
    substitutionJson,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendNormalizedPushNotificationToGroup = function (
    groupId,
    alertContentJson,
    customDataJson,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.scheduleRawPushNotificationUTC = function (
    profileId,
    fcmContent,
    iosContent,
    facebookContent,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.scheduleRawPushNotificationMinutes = function (
    profileId,
    fcmContent,
    iosContent,
    facebookContent,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendRawPushNotification = function (
    toProfileId,
    fcmContent,
    iosContent,
    facebookContent,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendRawPushNotificationBatch = function (
    profileIds,
    fcmContent,
    iosContent,
    facebookContent,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendRawPushNotificationToGroup = function (
    groupId,
    fcmContent,
    iosContent,
    facebookContent,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.scheduleNormalizedPushNotificationUTC = function (
    profileId,
    alertContentJson,
    customDataJson,
    startTime,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.scheduleNormalizedPushNotificationMinutes = function (
    profileId,
    alertContentJson,
    customDataJson,
    minutesFromNow,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.scheduleRichPushNotificationUTC = function (
    profileId,
    notificationTemplateId,
    substitutionJson,
    startTime,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.scheduleRichPushNotificationMinutes = function (
    profileId,
    notificationTemplateId,
    substitutionJson,
    minutesFromNow,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendNormalizedPushNotification = function (
    toProfileId,
    alertContentJson,
    customDataJson,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.pushNotification.sendNormalizedPushNotificationBatch = function (
    profileIds,
    alertContentJson,
    customDataJson,
    callback
