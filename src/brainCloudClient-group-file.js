...
function BCGroupFile () {
  ...
  bc.groupFile.OPERATION_CHECK_FULLPATH_FILENAME_EXISTS =
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.groupFile.getFileInfoSimple = function (
    groupId,
    folderPath,
    filename,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.groupFile.checkFilenameExists = function (
    groupId,
    folderPath,
    filename,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.groupFile.checkFullpathFilenameExists = function (
    groupId,
    fullPathFilename,
    callback
  ) {
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.groupFile.moveFile = function (
    groupId,
    fileId,
    version,
    newTreeId,
   ...
   * @param callback The method to be invoked when the server response is received
   * */
  bc.groupFile.updateFileInfo = function (
    groupId,
    fileId,
    version,
    newFilename,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.groupFile.copyFile = function (
    groupId,
    fileId,
    version,
    newTreeId,
  ...
  /**
         ...
         */
  bc.groupFile.deleteFile = function (
    groupId,
    fileId,
    version,
    filename,
