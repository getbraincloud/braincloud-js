...
function BCUserItems () {
  ...
  bc.userItems.OPERATION_GET_ITEM_PROMOTION_DETAILS =
  ...
  bc.userItems.OPERATION_GET_USER_INVENTORY_PAGE_OFFSET =
  ...
  bc.userItems.OPERATION_PUBLISH_USER_ITEM_TO_BLOCKCHAIN =
  ...
  bc.userItems.OPERATION_REFRESH_BLOCKCHAIN_USER_ITEMS =
    'REFRESH_BLOCKCHAIN_USER_ITEMS'
  bc.userItems.OPERATION_REMOVE_USER_ITEM_FROM_BLOCKCHAIN =
   ...
   */
  bc.userItems.awardUserItem = function (
    defId,
    quantity,
    includeDef,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.awardUserItemWithOptions = function (
    defId,
    quantity,
    includeDef,
    optionsJson,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.dropUserItem = function (
    itemId,
    quantity,
    includeDef,
    callback
   ...
   */
  bc.userItems.getItemsOnPromotion = function (
    shopId,
    includeDef,
   ...
   * @param callback                 Callback invoked when the server response is received.
   */
  bc.userItems.getItemPromotionDetails = function (
    defId,
    shopId,
    includeDef,
    includePromotionDetails,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.getUserItemsPageOffset = function (
    context,
    pageOffset,
    includeDef,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.giveUserItemTo = function (
    profileId,
    itemId,
    version,
    quantity,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.openBundle = function (
    itemId,
    version,
    quantity,
    includeDef,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.purchaseUserItem = function (
    defId,
    quantity,
    shopId,
    includeDef,
   ...
   */
  bc.userItems.purchaseUserItemWithOptions = function (
    defId,
    quantity,
    shopId,
    includeDef,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.sellUserItem = function (
    itemId,
    version,
    quantity,
    shopId,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.updateUserItemData = function (
    itemId,
    version,
    newItemData,
    callback
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.useUserItem = function (
    itemId,
    version,
    newItemData,
    includeDef,
   ...
   * @param callback The method to be invoked when the server response is received
   */
  bc.userItems.publishUserItemToBlockchain = function (
    itemId,
    version,
    callback
  ) {
   ...
   * @param callback Callback invoked when the server response is received.
   */
  bc.userItems.removeUserItemFromBlockchain = function (
    itemId,
    version,
    callback
  ) {
